...
- [weatherapp-api](https://github.com/bcarusodev/weatherapp-api) - Check any city weather dynamically
- [storeapp-api](https://github.com/bcarusodev/storeapp-api) - storeapp API repo
- [storeapp](https://github.com/bcarusodev/storeapp) - Full Stack practice project, trying to replicate a app store
- [ejercfinalmtbonus](https://github.com/bcarusodev/ejercfinalmtbonus) - Work challenge bonus exercise (for MerlionTechs)
